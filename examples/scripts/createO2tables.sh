...
### run configuration
NJOBS=55       # number of max parallel runs
...
if [ $DOANALYSIS -eq 1 ]; then
  ...
  #O2EXEC="o2-analysis-hftrackindexskimscreator $O2ARGS | o2-analysis-hfcandidatecreator2prong $O2ARGS | o2-analysis-taskdzero $O2ARGS -b |o2-analysis-qatask --aod-file $AOD3NAME -b"
